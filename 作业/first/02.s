...
0000000000001090 <gets@plt>:
    ...
    1094:	f2 ff 25 35 2f 00 00 	bnd jmpq *0x2f35(%rip)        # 3fd0 <gets@GLIBC_2.2.5>
...
0000000000001189 <main>:
    ...
    11c8:	e8 b3 fe ff ff       	callq  1080 <printf@plt>
    11cd:	48 8d 45 a0          	lea    -0x60(%rbp),%rax
    11d1:	48 89 c6             	mov    %rax,%rsi
    11d4:	48 8d 3d 34 0e 00 00 	lea    0xe34(%rip),%rdi        # 200f <_IO_stdin_used+0xf>
    11db:	b8 00 00 00 00       	mov    $0x0,%eax
    11e0:	e8 9b fe ff ff       	callq  1080 <printf@plt>
    11e5:	b8 00 00 00 00       	mov    $0x0,%eax
    11ea:	48 8b 55 f8          	mov    -0x8(%rbp),%rdx
    11ee:	64 48 33 14 25 28 00 	xor    %fs:0x28,%rdx
    11f5:	00 00 
    11f7:	74 05                	je     11fe <main+0x75>
    11f9:	e8 72 fe ff ff       	callq  1070 <__stack_chk_fail@plt>
    11fe:	c9                   	leaveq 
    11ff:	c3                   	retq   
